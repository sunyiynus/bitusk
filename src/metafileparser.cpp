...
const std::basic_string<unsigned char> MetafileObject::CaculateSha1(
...
std::shared_ptr<MetafileObject> MetafileObject::readMetaStrFromFile(
...
const MetafileObject::dict_type MetafileObject::getDict(
